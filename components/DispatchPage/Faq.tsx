...
export default function Faq() {
	...
	return (
		<>
            ...
            {/* Left */}
            <span style={{paddingBottom: "2px"}}className="topRow"><FaqQuestion question="How do I request a Dispatch? " answer={<div>If you're a community owner looking to request a dispatch, please visit our <a style={{color: "lightblue"}} href="/discord">Discord Server</a> & open up a ticket in our <a style={{color: "lightblue"}} href="https://discord.com/channels/791278367960858635/809494449780424744">Support Channel</a>. We'll get back to you ASAP!</div>} /></span>
